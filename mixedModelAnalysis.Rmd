...
W1[1:4,1:4]
save(W1, file = "./data/matrixspectchipcc50.rdata")
```


```{r}
y <- as.vector(chips_spec_yield$yield)
data=data.frame(y=y,w_id=rep(rownames(W),4),a_id=rep(rownames(A),4))
...
save(W2, file = "./data/matrixspectchipccfl.rdata")
```
...
save(W3, file = "./data/matrixspectchippeakfl.rdata")
```
...
save(W4, file = "./data/matrixspectchipvBio.rdata")
```
...
save(W5, file = "./data/matrixspectchipS1.rdata")
```
...
save(W6, file = "./data/matrixspectchipS2.rdata")
```
